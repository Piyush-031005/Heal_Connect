    ...
    <tr>
      <td style="padding:40px;">
        ...
        <p style="color:#6b7280;font-size:16px;line-height:1.7;margin:0 0 16px;">
          ...
          You are now live on the Zenauraa platform and users can discover and connect with you.
        </p>
        <p style="color:#6b7280;font-size:16px;line-height:1.7;margin:0 0 8px;">Here's what to do next:</p>
        <ul style="color:#6b7280;font-size:15px;line-height:1.9;margin:0 0 28px;padding-left:20px;">
