...
export default function LoginScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#EDE9FE' }}>
      ...
      <GhostFibers lineColor="#C084FC" glowColor="#9333EA" speed={0.3} scale={0.8} brightness={10.0} blueBoost={0.6} lightMode={true} layers={40} lineFrequency={40} lineSpacing={0.8} glowIntensity={10.0} />
        ...
        >
          ...
          <View style={{
            ...
            <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, borderRadius: 32, overflow: 'hidden' }}>
              <GhostFibers lineColor="#DDD6FE" glowColor="#C084FC" speed={0.18} scale={0.6} brightness={12.0} blueBoost={0.3} lightMode={true} layers={35} lineFrequency={35} lineSpacing={0.6} glowIntensity={12.0} />
            </View>
