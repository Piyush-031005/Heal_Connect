        ...
        <header className={`mx-auto transition-all duration-300 flex items-center justify-between px-4 h-14 ${
          ...
          <div className="flex items-center gap-2">
            ...
            {userProfile ? (
              ...
              <>
                <Link href="/login" className={`hidden md:block text-sm font-bold px-4 py-1.5 rounded-full transition-colors ${isFinalHybrid ? 'text-white bg-[#FAD058] hover:bg-[#E5B83C]' : 'text-primary bg-[#FAD058] hover:bg-[#E5B83C]'}`}>
                  Login
                </Link>
                {isFinalHybrid && (
                  <Link href="/register" className="hidden md:block text-sm font-bold text-white bg-[#FAD058] hover:bg-[#E5B83C] transition-colors px-4 py-1.5 rounded-full ml-1 shadow-sm">
                    Register
                  </Link>
                )}
              </>
