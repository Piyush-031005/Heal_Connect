        ...
        <div className="bg-gradient-to-br from-purple-300 to-purple-400 px-5 pt-6 pb-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2.5">
              <Image src={theme === 'theme-royal-indigo' ? '/main/main_logo.png' : '/main/main_logo.png'} alt="ZenAuraa" width={32} height={32} className="rounded-full border-2 border-white/40" />
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <Link href="/" className="flex items-center gap-2">
                <Image src={theme === 'theme-royal-indigo' ? '/main/main_logo.png' : '/main/main_logo.png'} alt="ZenAuraa" width={30} height={30} className="rounded-full shadow-sm" unoptimized />
