...
export default function ModalityScrollGallery({ data }: Props) {
  ...
  return (
    <section className="py-24 bg-[#F3E8FF] border-t border-primary/10 overflow-hidden relative">
      ...
      */}
      <div className="relative w-full flex overflow-hidden py-10">
        ...
        <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#F3E8FF] to-transparent z-10" />
        <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#F3E8FF] to-transparent z-10" />
        ...
        >
          ...
          {[...data.scrollGallery, ...data.scrollGallery, ...data.scrollGallery, ...data.scrollGallery].map((img, i) => (
            <div 
              key={i} 
