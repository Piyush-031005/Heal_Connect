          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {t.servicesList.slice(0, 4).map((svc: any, idx: number) => (
              <div key={idx} className="group relative rounded-[2.5rem] overflow-hidden aspect-[4/5] cursor-pointer border border-red-900/10 bg-white hover:border-red-500/50 hover:shadow-[0_20px_50px_rgba(220,38,38,0.15)] transition-all duration-700">
                <img src={['/new-zodiacs/aries_new.png','/new-zodiacs/taurus.png','/new-zodiacs/gemini_new.png','/new-zodiacs/cancer.png'][idx] || `/zodiacs/red/red_${idx + 1}.png`} className="absolute inset-0 w-full h-full object-contain p-8 opacity-40 transition-transform duration-[2s] group-hover:scale-110 group-hover:opacity-100" alt="Service" />
