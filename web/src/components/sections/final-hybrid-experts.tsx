...
export function FinalHybridExperts() {
  ...
  return (
    <section className="relative py-24 overflow-hidden border-b border-primary/50" style={isNewLayout ? { background: 'transparent' } : isZenAlign ? { background: 'linear-gradient(135deg, #5F3BA9 0%, #4E67CC 100%)' } : isNewColor ? { backgroundColor: '#2B2D31' } : { background: 'linear-gradient(135deg, #B79AE6 0%, #7A48AB 50%, #694091 100%)' }}>
