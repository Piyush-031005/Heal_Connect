        ...
        <div className="flex overflow-x-auto gap-6 pb-8 snap-x snap-mandatory scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
          {EXPERTS.map((expert, idx) => (
            <div 
              ...
              className={`w-[260px] min-w-[260px] md:w-[320px] md:min-w-[320px] flex-shrink-0 snap-start rounded-[2rem] p-6 relative group transition-all hover:-translate-y-1 shadow-lg cursor-pointer border ${isZenAlign ? "bg-[#2D1B54] border-[#4B2F6E] hover:shadow-[0_10px_30px_rgba(183,54,230,0.15)] hover:border-primary/50" : "bg-[#2D1B54] border-[#4B2F6E] hover:shadow-[0_10px_30px_rgba(183,54,230,0.15)] hover:border-primary/50"}`}
            >
              {/* Badges */}
              {expert.badge && (
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="relative">
                                    <div className="w-20 h-20 rounded-full border-2 border-primary/40 overflow-hidden group-hover:border-[#B79AE6] transition-colors">
                                          <img
                        src={expert.img}
                        alt={expert.name}
              ...
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className="flex-1 bg-transparent border border-primary text-[#7C3AED] py-2.5 rounded-xl text-xs font-bold hover:bg-primary hover:text-primary-foreground transition-colors flex items-center justify-center gap-1.5"
                >
