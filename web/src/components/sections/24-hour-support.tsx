        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link
                href="/app-store"
                className="bg-white text-[#4D316B] px-6 py-3.5 rounded-xl text-sm font-bold shadow-lg hover:bg-purple-50 transition-all flex items-center gap-2"
              >
          ...
          <div className="lg:w-1/2 w-full flex justify-center lg:justify-end">
            ...
            <div className="relative w-full max-w-[320px] h-[640px] bg-white rounded-[3rem] p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] border-4 border-purple-100">
              {/* Notch */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-purple-50 rounded-b-2xl z-20"></div>
              ...
              <div className="w-full h-full bg-[#f8f9fa] rounded-[2rem] overflow-hidden flex flex-col relative">
                ...
                <div className="bg-white pt-8 pb-3 px-4 border-b flex items-center justify-between z-10 shadow-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-purple-900 leading-tight">Riya</h4>
                  ...
                  <div className="flex gap-3">
                    ...
                    <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path></svg>
                  </div>
                </div>

                {/* Chat Area */}
                <div className="flex-1 p-4 flex flex-col gap-4 overflow-y-auto bg-purple-50/50">
                  <div className="flex gap-2">
                    ...
                    <div>
                      <div className="bg-white p-3 rounded-2xl rounded-tl-none shadow-sm text-xs text-purple-800 border border-purple-100">
                        Hello! How can I help you today?
                      </div>
                      <p className="text-[9px] text-purple-400 mt-1 ml-1">9:41 AM</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2 flex-row-reverse">
                    <div>
                      ...
                      <p className="text-[9px] text-purple-400 mt-1 mr-1 text-right">9:42 AM ✓</p>
                    </div>
                  </div>

                  <div className="flex gap-2 mt-2">
                    <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=100&auto=format&fit=crop" alt="Riya" className="w-6 h-6 rounded-full shrink-0" />
                    <div className="bg-violet-100 p-3 rounded-full flex gap-1 items-center h-8">
                      <div className="w-1.5 h-1.5 bg-violet-400 rounded-full animate-bounce"></div>
                      <div className="w-1.5 h-1.5 bg-violet-400 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                      <div className="w-1.5 h-1.5 bg-violet-400 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-3 border-t flex gap-2 items-center">
                  <svg className="w-5 h-5 text-purple-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                  <div className="flex-1 bg-purple-50 rounded-full h-8 flex items-center px-3">
                    <span className="text-[11px] text-purple-400">Type a message...</span>
                  </div>
