...
export default function FloatingOrbs() {
  ...
  return (
    <div className="relative w-[550px] h-[550px] flex items-center justify-center scale-90 lg:scale-100">
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        {[1, 2, 3].map(i => (
          <div key={i} className="absolute rounded-full border-2 border-[#8982D0]/40" style={{width: `${150 + i * 140}px`, height: `${150 + i * 140}px`, animation: `ripple 6s linear ${i * 2}s infinite`}} />
        ))}
      </div>
        ...
        return (
          ...
          >
            <div 
              ...
              style={{ width: size, height: size, background: 'linear-gradient(135deg, rgba(137, 130, 208, 0.85) 0%, rgba(78, 103, 204, 0.85) 100%)' }}
            >
