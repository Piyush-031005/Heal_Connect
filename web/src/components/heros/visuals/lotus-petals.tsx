        ...
        {MODALITIES.map((mod, i) => {
          ...
          return (
            <div 
              ...
              style={{ transform: `rotate(${rotation}deg) translateY(-240px)` }} // Pushed much further out
            >
              <div 
              ...
              >
                <span className="mb-4 text-xs font-bold text-[#1E2059] bg-white/70 backdrop-blur-md px-3 py-1 rounded-full whitespace-nowrap transform -rotate-180 opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all border border-white/50 shadow-sm">
                  {mod.name}
                </span>
                {/* BIGGER AND NICER PETAL */}
