      ...
      <div className="absolute right-0 top-0 bottom-0 w-[65%] pointer-events-none" style={{ zIndex: 5 }}>
        <div
          ...
          style={{
            ...
            opacity: 0.9,
            WebkitMaskImage: "radial-gradient(ellipse at 80% 50%, black 30%, transparent 75%)",
            maskImage: "radial-gradient(ellipse at 80% 50%, black 30%, transparent 75%)"
          }}
        />
      </div>
    </section>
          ...
          >
            ...
            >
              ...
              <div className={`relative lg:absolute left-1/2 -translate-x-1/2 lg:left-auto lg:top-1/2 lg:right-0 translate-y-[20%] lg:-translate-y-1/2 lg:translate-x-[75%] flex items-center justify-center rounded-full z-10 pointer-events-none mb-8 lg:mb-0 ${isNewColor ? 'w-[400px] h-[400px] sm:w-[450px] sm:h-[450px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px]' : 'w-[450px] h-[450px] sm:w-[500px] sm:h-[500px] md:w-[450px] md:h-[450px] lg:w-[500px] lg:h-[500px]'}`}>
                ...
                {/* THE REVOLVING ORBIT - , icons counter-rotate to stay upright */}
                <motion.div
                  animate={{ rotate: 360 }}
            ...
            >
              <div className="shrink-0">
                <p className={`text-xl md:text-2xl font-serif ${isNewColor ? 'text-white' : 'text-white'}`}>4.9★</p>
