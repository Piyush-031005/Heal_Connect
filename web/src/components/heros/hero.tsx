...
function PrimaryHero() {
  return (
    <section className="relative overflow-hidden pt-28 pb-16 lg:pt-32 lg:pb-32 min-h-[90vh] flex items-center" style={{ background: 'linear-gradient(135deg, #F5EEFF 0%, #EADDFF 40%, #D8B4FE 70%, #C084FC 100%)', color: '#1e1b4b' }}>
