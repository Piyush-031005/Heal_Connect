...
function PrimaryHero() {
  return (
    <section className="relative overflow-hidden pt-28 pb-16 lg:pt-32 lg:pb-32 min-h-[90vh] flex items-center" style={{ background: 'linear-gradient(135deg, #FDFBFF 0%, #F3EBFF 30%, #E2D1F9 60%, #B794F4 100%)', color: '#1e1b4b' }}>
            ...
            <div className="relative w-full h-full pointer-events-none z-10">
              <div
                ...
                style={{
                  ...
                  opacity: 0.95,
                  WebkitMaskImage: "radial-gradient(ellipse 65% 75% at 55% 50%, black 50%, rgba(0,0,0,0.6) 75%, transparent 90%)",
                  maskImage: "radial-gradient(ellipse 65% 75% at 55% 50%, black 50%, rgba(0,0,0,0.6) 75%, transparent 90%)"
                }}
              />
            </div>
          </div>
