...
function NewLayout1Hero() {
  return (
    <section className="relative overflow-hidden pt-28 pb-16 lg:pt-40 lg:pb-32 bg-[#F9F5FF] text-[#2A1658] min-h-[90vh] flex items-center"><div className="absolute inset-0 z-0"><GhostFibers lineColor="#362d64" glowColor="#8b53c1" speed={0.2} scale={2} /></div>
      {/* Scattered star particles ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â like ZenAuraa reference */}
      <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" xmlns="http://www.w3.org/2000/svg">
        {[
          [8,12],[15,65],[22,38],[30,82],[38,18],[45,55],[52,90],[60,28],[68,72],[75,45],
          ...
          <div className="lg:col-span-7 z-10">
            ...
            <div className="flex items-center bg-card rounded-full p-2 max-w-xl shadow-lg border border-primary/10">
              ...
              <input 
                ...
                className="flex-1 bg-transparent border-none focus:outline-none text-[#2A1658] placeholder:text-muted-foreground"
              />
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.h1 
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}
              className={`text-6xl md:text-8xl font-serif font-medium tracking-tight mb-6 leading-[1.1] transition-colors duration-500 ${isNewColor ? 'text-white' : 'text-[#2A1658]'}`}
            >
          ...
          >
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <span className={`text-[14px] md:text-[16px] font-bold mt-3 tracking-wide whitespace-nowrap drop-shadow-md transition-colors duration-500 ${isNewColor ? 'text-white' : 'text-[#2A1658]'}`}>{mod.label}</span>
                      </motion.div>
                    </motion.div>
                  );
                })}
            ...
            >
              <div className="shrink-0">
                <p className={`text-xl md:text-2xl font-serif ${isNewColor ? 'text-white' : 'text-[#2A1658]'}`}>4.9ÃƒÂ¢Ã‹Å“Ã¢â‚¬Â¦</p>
              ...
              <div className="shrink-0">
                <p className={`text-xl md:text-2xl font-serif ${isNewColor ? 'text-white' : 'text-[#2A1658]'}`}>100k+</p>
              ...
              <div className={`w-px h-8 shrink-0 ${isNewColor ? 'bg-white/30' : 'bg-primary/30'}`} />
              <div className="shrink-0">
                <p className={`text-xl md:text-2xl font-serif ${isNewColor ? 'text-white' : 'text-[#2A1658]'}`}>500+</p>
              ...
              <div className={`w-px h-8 shrink-0 ${isNewColor ? 'bg-white/30' : 'bg-primary/30'}`} />
              <div className="shrink-0">
                <p className={`text-xl md:text-2xl font-serif ${isNewColor ? 'text-white' : 'text-[#2A1658]'}`}>24x7</p>
