...
function PrimaryHero() {
  return (
    <section className="relative overflow-hidden pt-28 pb-16 lg:pt-40 lg:pb-32 bg-background min-h-[90vh] flex items-center">
      ...
      <div className="absolute right-0 translate-x-[25%] md:translate-x-[20%] lg:translate-x-[15%] top-1/2 -translate-y-1/2 h-[800px] w-[800px] md:h-[950px] md:w-[950px] lg:h-[1100px] lg:w-[1100px] opacity-90 lg:opacity-100 z-10 pointer-events-none lg:pointer-events-auto flex items-center justify-center">
        <OpticalWheel />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className={`relative lg:absolute left-1/2 -translate-x-1/2 lg:left-auto lg:top-1/2 lg:right-0 translate-y-[20%] lg:-translate-y-1/2 lg:translate-x-[65%] flex items-center justify-center rounded-full z-10 pointer-events-none mb-8 lg:mb-0 ${isNewColor ? 'w-[400px] h-[400px] sm:w-[450px] sm:h-[450px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px]' : 'w-[450px] h-[450px] sm:w-[500px] sm:h-[500px] md:w-[550px] md:h-[550px] lg:w-[700px] lg:h-[700px]'}`}>
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Link href={`/modalities/${mod.id}`} className="w-16 h-16 md:w-16 md:h-16 flex items-center justify-center rounded-full bg-black/80 border border-white/10 p-3 transition-all duration-500 hover:scale-110 drop-shadow-[0_0_15px_rgba(var(--primary),0.5)] hover:drop-shadow-[0_0_25px_rgba(var(--primary),0.8)] relative overflow-hidden">
