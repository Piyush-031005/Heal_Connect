...
function PrimaryHero() {
  return (
    <section className="relative overflow-hidden pt-28 pb-16 lg:pt-32 lg:pb-32 min-h-[90vh] flex items-center" style={{ background: 'linear-gradient(135deg, #F9F5FF 0%, #F3E8FF 30%, #E9D5FF 60%, #C084FC 100%)', color: '#1e1b4b' }}>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 z-20 flex flex-col justify-center">
            ...
            <div className="flex gap-4 mb-8">
              <div className="bg-white rounded-3xl px-5 py-2.5 flex items-center gap-2 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] leading-none text-gray-500 font-medium">Download on the</span>
                  <span className="text-sm font-bold leading-tight text-black">App Store</span>
                </div>
              </div>
              <div className="bg-white rounded-3xl px-5 py-2.5 flex items-center gap-2 shadow-sm cursor-pointer hover:shadow-md transition-shadow">
                <svg viewBox="0 0 512 512" className="w-6 h-6 fill-black"><path d="M325.3 234.3L104.6 13l280.8 161.2-60.1 60.1zM47 0C34 6.8 25.3 19.2 25.3 35.3v441.3c0 16.1 8.7 28.5 21.7 35.3l256.6-256L47 0zm425.2 225.6l-58.9-34.1-65.7 64.5 65.7 64.5 60.1-34.1c18-14.3 18-46.5-1.2-60.8zM104.6 499l280.8-161.2-60.1-60.1L104.6 499z" /></svg>
                <div className="flex flex-col">
                  <span className="text-[10px] leading-none text-gray-500 font-medium">GET IT ON</span>
                  <span className="text-sm font-bold leading-tight text-black">Google Play</span>
                </div>
              </div>
            </div>
          ...
          {/* RIGHT: Pure Image (No ring, no background effect, perfect circular mask) */}
          <div className="lg:col-span-7 relative h-[600px] flex items-center justify-end">
            <div className="relative w-full h-full pointer-events-none z-10 flex items-center justify-center translate-x-[15%]">
              <div
