...
export const HOROSCOPE_DATA: Record<number, { text: string; mood: string; luckyNum: number; color: string; colorClass: string; love: number; career: number; health: number; money: number; dateRange: string }> = {
  ...
  3: { text: "Cancer, focus on home and family today. Your emotional intuition is sharp — trust it. A creative project will bring you joy and a sense of accomplishment.", mood: "Nurturing", luckyNum: 2, color: "Silver", colorClass: "bg-violet-200", love: 85, career: 65, health: 80, money: 70, dateRange: "Jun 21 – Jul 22" },
