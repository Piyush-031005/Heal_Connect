          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" defaultValue="support@ZenAuraa.com" className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 outline-none" />
              </div>
            </div>
            <div>
