                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input type="email" required placeholder="you@example.com" value={email} onChange={e => setEmail(e.target.value)}
                      className="pl-10 py-6 bg-white/40 backdrop-blur-md border-white/10 border-white/20 text-white placeholder:text-white/70 focus-visible:ring-accent focus-visible:border-accent rounded-xl" />
                  </div>
                </div>
                <div className="space-y-2">
            ...
            {mode === 'login' && (
              <>
                ...
                <div className="space-y-3">
                  <Button type="button" variant="outline" onClick={handleGoogleSignIn} className="w-full py-6 bg-white/40 backdrop-blur-md border-white/10 border-white/20 hover:bg-white/40 backdrop-blur-md border-white/10 text-white shadow-sm transition-all rounded-xl">
                  ...
                  <Button type="button" variant="outline" onClick={handleAppleSignIn} className="w-full py-6 bg-white/40 backdrop-blur-md border-white/10 border-white/20 hover:bg-white/40 backdrop-blur-md border-white/10 text-white shadow-sm transition-all rounded-xl">
