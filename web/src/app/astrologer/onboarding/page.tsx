...
export default function AstrologerOnboardingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f6] flex flex-col md:flex-row font-sans">
      ...
      {/* Left panel */}
      <div className="hidden md:flex flex-col justify-between w-5/12 p-12 bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-700 relative overflow-hidden sticky top-0 h-screen">
