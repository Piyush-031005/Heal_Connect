...
export default function AstrologerLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f6] flex flex-col md:flex-row font-sans">
      ...
      {/* Left — Branding */}
      <div className="hidden md:flex flex-col justify-between w-1/2 p-12 bg-gradient-to-br from-indigo-500 via-purple-500 to-indigo-700 relative overflow-hidden">
