  ...
  return (
    <div className="min-h-screen bg-[#faf9f6] text-[#1a1a1a] flex flex-col font-sans">
      ...
      <main className="flex-grow container mx-auto px-4 py-10 max-w-6xl space-y-16">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-3 border-t border-purple-50 text-xs">
              ...
              {selectedFilters.map(f => (
                <span key={f} className="inline-flex items-center gap-1 bg-indigo-50 border border-indigo-200 text-indigo-700 px-3 py-1 rounded-full font-bold">
                  {f}
                  <button onClick={() => handleFilterClick(f)}><X className="w-3 h-3 text-indigo-600 hover:text-indigo-800" /></button>
                </span>
              ))}
        ...
        <section className="space-y-6">
          ...
          {filteredSigns.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-3xl border border-yellow-100/50 text-purple-400">
              ...
              <button onClick={clearFilters} className="mt-4 px-6 py-2 bg-indigo-500 text-white font-bold rounded-full text-xs">
                Reset Filters
              </button>
            </div>
          ) : (
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
            {CATEGORY_HOROSCOPES.map((cat) => (
              <motion.div
                ...
                className="bg-white border border-yellow-100 hover:border-indigo-200 hover:shadow-md rounded-3xl p-5 cursor-pointer transition-all flex flex-col justify-between h-full space-y-3"
              >
        ...
        <section className="rounded-3xl bg-white border border-yellow-100 p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            <Link href="/" className="flex-grow md:flex-grow-0">
              <button className="w-full px-6 py-3 rounded-full bg-indigo-500 hover:bg-indigo-600 text-white font-extrabold text-sm transition-all shadow-md">
                Chat with AI
              </button>
            </Link>
            <Link href="/dashboard" className="flex-grow md:flex-grow-0">
              <button className="w-full px-6 py-3 rounded-full bg-white hover:bg-indigo-50 border border-indigo-200 text-indigo-600 font-extrabold text-sm transition-all shadow-sm">
                Start Journaling
              </button>
            </Link>
          </div>
        ...
        <section className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-indigo-50 via-indigo-50/20 to-white border border-indigo-100 p-6 md:p-10 shadow-sm">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex items-center justify-center p-4">
              <img
                ...
                className="w-full max-w-[360px] md:max-w-[420px] h-auto rounded-3xl shadow-2xl border-4 border-indigo-200/80 hover:scale-105 transition-all duration-500 object-cover"
              />
            </div>
            ...
            <div className="space-y-6">
              ...
              <button 
                ...
                className="mt-4 flex items-center justify-center gap-2 px-8 py-3.5 rounded-full bg-indigo-500 hover:bg-indigo-600 text-white font-extrabold text-sm transition-all shadow-lg hover:shadow-indigo-500/20 hover:scale-105 active:scale-95"
              >
            ...
            >
              ...
              <div className="bg-gradient-to-r from-indigo-500 to-purple-500 text-white p-6 shrink-0 relative">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-extrabold font-sans">{selectedSign.name} <span className="font-cursive text-3xl font-normal text-indigo-100">Today&apos;s Horoscope</span></h2>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <h2 className="text-2xl md:text-3xl font-extrabold font-sans tracking-tight">
                      {selectedCategorySign.name} <span className="text-indigo-100 font-normal">• {selectedCategory.name}</span>
                    </h2>
