...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F9F5FF] via-[#E9D5FF] to-[#D8B4FE] text-[#2A1658] flex flex-col md:flex-row font-sans relative overflow-hidden">
      ...
      {/* Left Branding */}
      <div className="hidden md:flex flex-col justify-between w-1/2 p-12 bg-transparent relative z-10 border-r border-border overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-5">
              <div className="w-12 h-12 rounded-full bg-black/5 border border-border flex items-center justify-center shadow-[0_0_15px_rgba(214,180,107,0.2)]">
                <ShieldCheck className="w-6 h-6 text-[#2A1658]" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-5">
              <div className="w-12 h-12 rounded-full bg-black/5 border border-border flex items-center justify-center shadow-[0_0_15px_rgba(214,180,107,0.2)]">
                <Star className="w-6 h-6 text-[#2A1658]" />
              </div>
              <div>
