...
export default function ExpertOnboardingVerificationPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push('/expert/onboarding/submitted');
    ...
    <div className="min-h-screen bg-[#f5f3ff] flex flex-col md:flex-row font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-indigo-100 p-8 space-y-7">
            <div>
            ...
            <div className="flex justify-between items-center pt-2">
              <button onClick={() => router.push('/expert/onboarding/profile')} disabled={submitting}
