...
const inputCls = "w-full h-12 rounded-xl border border-indigo-200 bg-[#f5f3ff] pl-11 pr-4 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition";
    ...
    <div className="min-h-screen bg-[#f5f3ff] flex flex-col md:flex-row font-sans">
      ...
      <div className="hidden md:flex flex-col justify-between w-5/12 p-12 bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-indigo-100 text-lg font-medium mb-2">Discover. Connect. Thrive.</p>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            Already registered?{' '}
            <Link href="/expert/login" className="text-indigo-600 font-semibold hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
