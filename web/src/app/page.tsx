          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl">
              <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-extrabold tracking-tight leading-tight mb-8 animate-in slide-in-from-left duration-1000">
                ...
                <span className="bg-gradient-to-r from-primary via-orange-400 to-primary bg-clip-text text-transparent drop-shadow-lg">Confidence.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10 animate-in slide-in-from-left duration-1000 delay-300">
                <Link href="/practitioners">
                  <Button size="lg" className="bg-gradient-to-r from-primary to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white px-10 h-14 text-lg rounded-full font-bold shadow-[0_0_30px_rgba(255,109,0,0.4)] group border-none transition-all">
